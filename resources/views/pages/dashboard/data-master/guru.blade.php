<x-app-layout>
    ...
    <div class="flex flex-wrap justify-between gap-4 mb-7 lg:gap-0">
        ...
        <form action="{{ route('guru', request()->query()) }}">
                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200" id="datatable">
                        <thead class="bg-gray-50">
                            <tr>
                                <x-dashboard.table-column-header :columnId="0">NIP</x-dashboard.table-column-header>
                                <x-dashboard.table-column-header :columnId="1">Nama</x-dashboard.table-column-header>
                                <x-dashboard.table-column-header :columnId="1">Keterangan</x-dashboard.table-column-header>
                            </tr>
                        </thead>
