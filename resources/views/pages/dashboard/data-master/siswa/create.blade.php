    ...
    <x-dashboard.form-card>
        ...
        <form method="POST" action="{{ route('siswa.store') }}">
            ...
            <div class="mt-5">
                ...
                <x-input type="text" name="nama_siswa" id="nama_siswa" class="placeholder:!font-normal placeholder:text-[#252f3f66] block mt-1 w-full" :value="old('nama_siswa')" placeholder="Masukkan Nama Siswa" autofocus />
            </div>
            <div class="mt-5">
