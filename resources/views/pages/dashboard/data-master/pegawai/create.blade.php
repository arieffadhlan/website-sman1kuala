    ...
    <x-dashboard.form-card>
        ...
        <form method="POST" action="{{ route('pegawai.store') }}">
            ...
            <div class="mt-5 mb-7">
                ...
                <x-input type="text" name="ket_pegawai" id="ket_pegawai" class="placeholder:!font-normal placeholder:text-[#252f3f66] block mt-1 w-full" :value="old('ket_pegawai')" placeholder="Masukkan keterangan pegawai" />
            </div>
