    ...
    <x-dashboard.form-card>
        ...
        <form method="POST" action="{{ route('fasilitas.update', $facilities['0']->id) }}">
            ...
            <div class="mt-5 mb-7">
                ...
                <x-input type="text" name="deskripsi" id="deskripsi" class="placeholder:!font-normal placeholder:text-[#252f3f66] block mt-1 w-full" :value="old('deskripsi', $facilities['0']->deskripsi)" placeholder="Masukkan Deskripsi Fasilitas" autofocus />
            </div>
