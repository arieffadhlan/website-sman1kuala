    ...
    <x-dashboard.form-card>
        ...
        <form method="POST" action="{{ route('guru.store') }}">
            ...
            <div>
                ...
                <x-input type="text" name="nip" id="nip" class="placeholder:!font-normal placeholder:text-[#252f3f66] block mt-1 w-full" :value="old('nip')" placeholder="Masukkan NIP" autofocus />
            </div>
            <div class="mt-5">
                <x-label for="nama_guru" :value="__('Nama Guru')" />
                <x-input type="text" name="nama_guru" id="nama_guru" class="placeholder:!font-normal placeholder:text-[#252f3f66] block mt-1 w-full" :value="old('nama_guru')" placeholder="Masukkan nama guru" autofocus />
            </div>
            <div class="mt-5">
            ...
            <div class="mt-5">
                ...
                <x-input type="text" name="golongan_guru" id="golongan_guru" class="placeholder:!font-normal placeholder:text-[#252f3f66] block mt-1 w-full" :value="old('golongan_guru')" placeholder="Masukkan golongan guru" autofocus />
            </div>
            <div class="mt-5 mb-7">
                <x-label for="keterangan_guru" :value="__('Keterangan Guru')" />
                <x-input type="text" name="keterangan_guru" id="keterangan_guru" class="placeholder:!font-normal placeholder:text-[#252f3f66] block mt-1 w-full" :value="old('keterangan_guru')" placeholder="Masukkan keterangan" autofocus />
            </div>
