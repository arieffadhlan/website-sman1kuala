    ...
    <x-dashboard.form-card>
        ...
        <form method="POST" action="{{ route('fasilitas.store') }}" enctype="multipart/form-data">
            ...
            <div class="mt-5">
                ...
                <x-input type="text" name="deskripsi" id="deskripsi" class="placeholder:!font-normal placeholder:text-[#252f3f66] block mt-1 w-full" :value="old('deskripsi')" placeholder="Masukkan deskripsi fasilitas" />
            </div>
            <div class="mt-5 mb-7">
