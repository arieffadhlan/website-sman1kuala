                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200" id="datatable">
                        <thead class="bg-gray-50">
                            <tr>
                                <x-dashboard.table-column-header :columnId="0">NIS</x-dashboard.table-column-header>
                                <x-dashboard.table-column-header :columnId="1">Nama</x-dashboard.table-column-header>
                                <x-dashboard.table-column-header :columnId="1">Jenis Kelamin</x-dashboard.table-column-header>
                                <x-dashboard.table-column-header :columnId="1">Agama</x-dashboard.table-column-header>
                                <x-dashboard.table-column-header :columnId="1">Kelas</x-dashboard.table-column-header>
                            </tr>
                        </thead>
